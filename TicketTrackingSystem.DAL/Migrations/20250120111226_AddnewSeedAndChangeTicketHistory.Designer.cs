...
namespace TicketTrackingSystem.DAL.Migrations
{
    ...
    [Migration("20250120111226_AddnewSeedAndChangeTicketHistory")]
    partial class AddnewSeedAndChangeTicketHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketTrackingSystem.Core.Model.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "90472466-57a6-4b4d-97de-0cb24f7e1ed5",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAsmmD+qu+Sp15zmYmFTA0Hg1AbM+R+LjrpBq2IAPlstwD/maoKRFmKn3lSPDARu2A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "81b9045f-c592-41c0-9c0f-5e6508717183",
            ...
            modelBuilder.Entity("TicketTrackingSystem.Core.Model.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("3e353a51-e46d-446c-a385-38d8f6ddeb79"),
                            IsDeleted = false,
                            Name = "ViewTicketMessage"
                        },
                        new
                        {
                            Id = new Guid("607aa269-da9e-498c-9ce6-9cf380583542"),
                            IsDeleted = false,
                            Name = "EditTicketMessage",
                            ParentId = new Guid("3e353a51-e46d-446c-a385-38d8f6ddeb79")
                        },
                        new
                        {
                            Id = new Guid("4c93ec77-b8a5-4b58-aa26-1d854e81b666"),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("ad7c90eb-083d-4a09-b99e-6bd25e30c5b3"),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("200a2920-d8fd-4d10-9ff9-30a6156a5879"),
                            IsDeleted = false,
                            Name = "ViewTicketReport"
                        },
                        new
                        {
                            Id = new Guid("8dc4ddc3-c1e4-4e32-a1e0-508baa89b3db"),
                            IsDeleted = false,
                            Name = "EditTicketReport",
                            ParentId = new Guid("200a2920-d8fd-4d10-9ff9-30a6156a5879")
                        },
                        new
                        {
                            Id = new Guid("6170d82b-9e6f-41db-9bcf-c4c265bf0f37"),
                            IsDeleted = false,
                            Name = "DeleteTicketReport",
                            ParentId = new Guid("200a2920-d8fd-4d10-9ff9-30a6156a5879")
                        },
                        new
                        {
                            Id = new Guid("6d774c98-7bd9-40a4-a735-2c433c1f2d03"),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("TicketTrackingSystem.Core.Model.TicketHistory", b =>
                {
                    ...
                    b.HasOne("TicketTrackingSystem.Core.Model.TicketHistory", "Parent")
                        .WithOne()
                        .HasForeignKey("TicketTrackingSystem.Core.Model.TicketHistory", "ParentId");
